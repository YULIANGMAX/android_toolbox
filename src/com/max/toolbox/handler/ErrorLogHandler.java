...
package com.max.toolbox.handler;
...
public class ErrorLogHandler implements UncaughtExceptionHandler {
    ...
    /** 保证只有一个ErrorLogHandler实例 */
    private ErrorLogHandler() {
    }

    /** 获取ErrorLogHandler实例 ,单例模式 */
